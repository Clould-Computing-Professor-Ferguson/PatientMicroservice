...
| `curl -X POST "http://127.0.0.1:8000/patients" -H "Content-Type: application/json" -d '{"id": "jw4804", "first_name": "John", "last_name": "Doe", "condition": "Flu"}'` | POST request |
...
|`TRUNCATE TABLE patients` | remove all tuple in this table |
